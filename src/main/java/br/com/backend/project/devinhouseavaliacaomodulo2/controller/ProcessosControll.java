...
public class ProcessosControll {
	...
	@RequestMapping(value = "/v1" + "/criar-processo", method = RequestMethod.POST, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE)
	public List<ProcessoDTO> criarProcesso(@RequestBody ProcessoDTO novoProcesso) {
		return service.criarProcesso(novoProcesso);
	}
	
	@RequestMapping(value = "/v1" + "/consultar-todos-processos", method = RequestMethod.GET, produces = APPLICATION_JSON_VALUE )
	public List<ProcessoDTO> consultarTodosOsProcessos() {
		return service.retornarTodosOsProcessos();
	}
	
	@RequestMapping(value = "/v1" + "/consultar-processo-porid", method = RequestMethod.GET, produces = APPLICATION_JSON_VALUE)
	...
	@RequestMapping(value = "/v1" +"/consultar-processo-porchave", method = RequestMethod.GET, produces = APPLICATION_JSON_VALUE)
	public ProcessoDTO consultarProcessoPorChaveDeProcesso(@RequestParam String chaveDeProcesso) {
		return service.retornarProcessoPorChaveDeProcesso(chaveDeProcesso);
	}

	@RequestMapping(value = "/v1" + "/atualizar-processo", method = RequestMethod.PUT, consumes = APPLICATION_JSON_VALUE, produces = APPLICATION_JSON_VALUE )
	...
	@RequestMapping(value = "/v1" +"/deletar-processo", method = RequestMethod.DELETE, produces = APPLICATION_JSON_VALUE)
